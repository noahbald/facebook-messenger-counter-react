...
import {Zone, renderFooter} from './Tools.js'
import './App.css'
            ...
            <section id="privacy">
                <Zone>
                    <div style={{padding: "32px"}}>
                        ...
                        <p>I operate this site 'Facebook Messenger Counter', to provide the service of generating graphs and statistics for a user's message history</p>
                        ...
                        <h3>Security</h3>
                        <p>We understand that you need to trust us when providing the personal information required to use our service. We strive to use acceptable means of protecting your data. Remember no method of information transmission over the internet or electronic storage is perfectly secure and reliable.
                        We cannot guarantee the absolute safety of your data. Remember to take precaution when sharing personal information with any electronic service</p>
                        ...
                        <p>We may update our privacy policy from time to time. Thus, we advise you to review this page periodically for any changes. Any changes made are effective immediately after they are posted to this page.</p>
                        <h3>&nbsp;</h3>
